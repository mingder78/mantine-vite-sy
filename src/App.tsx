...
import GalleryWithModal from "./pages/GalleryWithModal";
    ...
    >
      ...
      <AppShell.Main>
        <Routes>
          ...
          <Route
            path="/writing-Body-Moving-Strokes"
            element={<WritingBodyMovingStrokes />}
          />
          <Route path="/seeding-Her-Feet" element={<SeedingHerFeet />} />
          <Route path="/GalleryWithModal" element={<GalleryWithModal />} />
