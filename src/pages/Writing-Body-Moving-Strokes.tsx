      ...
      <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="xl" verticalSpacing="xl">
        ...
        <div>
          ...
          <Box>
            ...
            <Text size="sm">Type ｜ research, body language, performance</Text>
        ...
        <div>
          ...
          <Box>
            <Text size="sm" lh={1.8} c="dimmed">
              《書寫身體，風動筆畫》為主持藝術家王思懿長期創作研究「字築 Zi Zhu:
              Hanzi Building
              Practice」之延伸實驗，以漢字作為空間與感知的媒介，聚焦漢字文化中潛藏的空間性與身體性，進一步探索身體、空間與氣候感知之間的交互關係。
            </Text>
          </Box>
        </div>
        <div>
