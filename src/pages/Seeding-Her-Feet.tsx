      ...
      <div>
        ...
        <Box>
          <Text size="sm  " fs="italic">
            A spatial plan for artworks ‘Seeding my feets in the chant of bells’
            by Mehraneh Atashi.
          </Text>
        </Box>
      </div>
      ...
      <div>
        <Box>
          <Text size="sm" lh={1.8} fs="italic">
            “There's resonating vibe among the pieces. All subtle movements and
            narrative vibrations (either conceptually or specifically) inhabit
            the gallerie room—the room for the healing vibe and all healed
            minds. Lovely to see people taking their time to immerse themselves
            in…” (Notes from Szu)
          </Text>
        </Box>
      </div>
        ...
        <Box>
          <Stack gap={32}>
            ...
            <Text size="sm" lh={1.8} c="dimmed" fs="italic">
              The collaboration is a journey of thinking along with her thoughts
              and developing the corresponding spatial gestures and narrative
              practice. And the realization is the process of knowing and
              learning from your artworks and spirit.
            </Text>
        ...
        <Box>
          <Stack gap={32}>
            <Text size="sm" lh={1.8} c="dimmed" fs="italic">
              ...
              the languages we shared. The realization is the process of knowing
              and learning from your artworks and spirit.
            </Text>
            ...
            <Text size="sm" lh={1.8} c="dimmed" fs="italic">
              ...
              micro paces, re-rooted, and gradually connected amid the chant of
              the bells.
            </Text>
